---
type: moc
project: 03_Molecular_Dynamics_of_OC
status: active
date: 2026-08-20
tags:
  - meta
...
# 03_Molecular_Dynamics_of_OC — MOC

> [!info] Scope
> Molecular dynamics simulation of *Oryza coarctata* proteins.
...
| 04 | [[04_processed_data]] | cleaned/derived matrices, trajectories |
...
FROM "01_Projects/03_Molecular_Dynamics_of_OC"
...
FROM "01_Projects/03_Molecular_Dynamics_of_OC/09_literature"
WHERE type = "paper"
SORT year DESC
```
...
FROM "01_Projects/03_Molecular_Dynamics_of_OC/10_lab_notebook"
SORT file.cday DESC
LIMIT 15
```
...
- [ ] Record force field, water model, and simulation length once — every downstream run inherits it
