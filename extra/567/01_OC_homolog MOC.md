...
> [!info] Scope
> Homolog identification in *Oryza coarctata*.
...
FROM "01_Projects/01_OC_homolog"
...
FROM "01_Projects/01_OC_homolog/09_literature"
WHERE type = "paper"
SORT year DESC
```
...
FROM "01_Projects/01_OC_homolog/10_lab_notebook"
SORT file.cday DESC
LIMIT 15
```
...
- [ ] Define the homolog-calling criteria (E-value, coverage, identity) and record them once
